...
A React application that displays course information including course name, parts, and exercise counts. This version demonstrates component-based architecture with separated components for better code organization and reusability.

## Features

- **Course Header**: Displays the coursde name
...
- **Component Architecture**: Organized into reusable components (Header, Content, Total, Course)
...
├── src/
│   ├── components/
│   │   ├── Content.jsx         # Component for displaying course content
│   │   ├── Course.jsx          # Main course component
│   │   └── Total.jsx           # Component for displaying total exercises
...
- Props and prop passing between components
